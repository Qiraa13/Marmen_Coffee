                    ...
                    <?php foreach ($orders as $order): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php endif; ?>
                                <button class="btn btn-sm btn-outline-warning" onclick="updatePayment(<?php echo $order['id']; ?>, '<?php echo $order['payment_status']; ?>')">
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="paymentSelect" class="form-label">Status Pembayaran</label>
...
function updatePayment(orderId, currentPaymentStatus) {
    document.getElementById('paymentOrderId').value = orderId;
    document.getElementById('paymentSelect').value = currentPaymentStatus;
