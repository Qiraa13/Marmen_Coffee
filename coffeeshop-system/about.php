...
<div class="container mt-5">
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-6">
            <h2>Tim Kami</h2>
            <p>Di balik setiap cangkir kopi yang sempurna, ada tim yang berdedikasi untuk memberikan pengalaman terbaik bagi setiap pelanggan.</p>
            
            <div class="row">
                <div class="col-6 mb-3">
                    <div class="text-center">
                        <img src="uploads/barista1.jpg" alt="Barista" class="rounded-circle mb-2" style="width: 80px; height: 80px; object-fit: cover;">
                        <h6>Ahmad Rizki</h6>
                ...
                <div class="col-6 mb-3">
                    <div class="text-center">
                        <img src="uploads/barista2.jpg" alt="Barista" class="rounded-circle mb-2" style="width: 80px; height: 80px; object-fit: cover;">
                        <h6>Sari Dewi</h6>
                        <small class="text-muted">Senior Barista</small>
                    </div>
                </div>
            </div>
        </div>
